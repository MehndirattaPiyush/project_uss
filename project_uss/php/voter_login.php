		 ...
		 <div class="col-md-4 col-md-offset-4 col-xs-12">
			<div class="login-panel panel panel-default">
				...
				<div class="panel-body">
					<form role="form" action="../db_files/voter_db.php" method="post">                         
						<!--div class="form-group">
							<input class="form-control" placeholder="Full Name" name="name" type="text" >
						</div-->
						<div class="form-group">
							<input class="form-control" placeholder="Enrollment No" name="roll_no" type="text" autofocus value="">
						</div>
						<div class="form-group">
						...
						<input type="submit" class="btn btn-md btn-success btn-block" value="Vote for the best !"/>                           
					</form>
				</div>
			</div>
		</div>       
